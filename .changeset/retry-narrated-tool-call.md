...
user sees an agent that announced work and then quit. Observed at roughly 12% of
turns under a real harness, costing either a user-visible stall or a full
sub-agent restart.
